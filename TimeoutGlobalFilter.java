package com.example.gateway.filter;`nimport com.example.gateway.manager.StrategyType;
...
public class TimeoutGlobalFilter implements GlobalFilter, Ordered {
    ...
    @Autowired
    private StrategyManager configManager;
    @Override
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        String routeId = getRouteId(exchange);
        TimeoutConfig config = configManager.getConfig(StrategyType.TIMEOUT, routeId);
