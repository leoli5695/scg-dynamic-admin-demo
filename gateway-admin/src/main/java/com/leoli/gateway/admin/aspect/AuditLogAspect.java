package com.leoli.gateway.admin.aspect;
...
public class AuditLogAspect {
    ...
    @AfterReturning(pointcut = "execution(* com.example.gatewayadmin.controller..*.*(..)) && " +
            "(within(com.leoli.gateway.admin.controller.RouteController) || " +
            " within(com.leoli.gateway.admin.controller.ServiceController) || " +
            " within(com.leoli.gateway.admin.controller.StrategyController))",
            returning = "result")
